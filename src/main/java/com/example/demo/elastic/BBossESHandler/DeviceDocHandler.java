package com.example.demo.elastic.BBossESHandler;
...
public class DeviceDocHandler {
    ...
    private final String mapperPath = "es/mapper/device.xml";
    ...
    public void createDeviceIndex() {
        ...
        try {
            ...
            //创建索引表device (索引表名称,索引表mapping dsl脚本名称，在esmapper/demo.xml中定义createDemoIndice)
